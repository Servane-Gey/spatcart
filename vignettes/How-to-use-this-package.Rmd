...
The features for the Paracou data set proposed in package **spatcart** are presented to cope with the experiments done in the article *Spatial Classification Trees*, by A. Bar-Hen, S. Gey and J.-M. Poggi, HAL 01837065 (2018). The original data set can be freely downloaded from [https://paracou.cirad.fr/](https://paracou.cirad.fr/).  
