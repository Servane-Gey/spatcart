...
The full description of the SpatCART algorithm can be found in the article *Spatial CART Classification Trees*, by A. Bar-Hen, S. Gey and J.-M. Poggi (2020).  
...
The features for the Paracou data set proposed in package **spatcart** are presented to cope with the experiments done in the article *Spatial CART Classification Trees*, by A. Bar-Hen, S. Gey and J.-M. Poggi (2020). The original data set can be freely downloaded from [https://paracou.cirad.fr/](https://paracou.cirad.fr/).  
